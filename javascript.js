document.addEventListener("DOMContentLoaded", function () {
    ...
    function displayTopActions() {
        if (displayTopArr[displayTopArr.length - 1] !== '+' && displayTopArr[displayTopArr.length - 1] !== '-' && displayTopArr[displayTopArr.length - 1] !== '*' && displayTopArr[displayTopArr.length - 1] !== '/') {
            displayTopArr.push(action);
        }
        if (action === '+') {
            if (displayTopArr[displayTopArr.length - 1] !== '-' || displayTopArr[displayTopArr.length - 1] !== '*' || displayTopArr[displayTopArr.length - 1] !== '/') {
